...
// ── Config ────────────────────────────────────────────────────────────────
const ENROLLED = 1057
const PRICE = Number(process.env.NEXT_PUBLIC_COURSE_PRICE) || 799
...
const REVIEWS = [
  { name: 'Ali Hassan', city: 'Dhaka', tag: 'Client Work', text: 'Pehla AI ad campaign successfully deliver kiya! Training ke foran baad. Course ne sab practical seekha diya.' },
  { name: 'Fatima Raza', city: 'Chittagong', tag: 'Content Creator', text: 'AI product photography aur faceless reels banana itna aasan ho gaya. Training ne workflow ko 10x fast kar diya.' },
  { name: 'Usman Malik', city: 'Sylhet', tag: 'Views', text: '2.8 million views ek video pe! AI podcast content ka koi jawab nahi.' },
  { name: 'Ayesha Khan', city: 'Rajshahi', tag: 'Freelancing', text: 'Upwork pe pehla AI design project complete kiya. Module 9 ne game change kar diya.' },
  { name: 'Hassan Javed', city: 'Khulna', tag: 'Faceless Page', text: 'Facebook page 0 se 50k followers tak 6 hafton mein. Organic growth ka kamaal.' },
  { name: 'Zainab Noor', city: 'Gazipur', tag: 'Skill', text: 'Prompt engineering wala module alone worth tha pure course ka price.' },
]
    ...
    <div className="mx-auto mt-12 max-w-4xl overflow-hidden rounded-2xl bg-[#0F172A] p-8 text-white shadow-xl">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        {[
          ...
          'bKash & Freelance Payment Guide (Payoneer, Wise)',
      ...
      <section id="top" className="hero-bg relative overflow-hidden dot-grid">
        <div className="mx-auto max-w-6xl px-4 pb-6 pt-8 text-center sm:px-6 sm:pb-8 sm:pt-12 md:pt-10">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-slate-500 sm:text-sm">
            {['Money-back guarantee', 'Lifetime access', 'Built for Bangladesh'].map(t => (
      ...
      <section className="px-4 pt-8 pb-14 sm:px-6 sm:pt-10 sm:pb-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 sm:text-base">
            Join over 1.1k members. Unlock courses, climb the leaderboards to win prizes, and network with Bangladesh's top AI creators.
          </p>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-blue-200/60 bg-white p-8 shadow-glow sm:p-12">
            ...
            <div className="relative text-center sm:text-left">
              ...
              <p className="mt-3 text-xs leading-relaxed text-slate-500 max-w-xl">
                Join {ENROLLED}+ students in Bangladesh mastering practical AI content creation, product photography, video production, and client workflows.
              </p>
      ...
      <section className="bg-white px-4 py-10 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-sm text-slate-500 sm:text-base max-w-md mx-auto">
            ৳{PRICE.toLocaleString()} one-time. Lifetime access. Money-back guarantee — see our <Link href="/terms" className="underline hover:text-blue-400">refund policy</Link>.
          </p>
          <Link
            href="/enroll"
