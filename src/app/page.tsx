...
const REVIEWS = [
  { name: 'Tanvir Ahmed', city: 'Dhaka', tag: 'Client Work', text: 'Pehla AI ad campaign successfully deliver kiya! Training ke foran baad. Course ne sab practical seekha diya.' },
  { name: 'Nusrat Jahan', city: 'Chittagong', tag: 'Content Creator', text: 'AI product photography aur faceless reels banana itna aasan ho gaya. Training ne workflow ko 10x fast kar diya.' },
  { name: 'Shakib Hasan', city: 'Sylhet', tag: 'Views', text: '2.8 million views ek video pe! AI podcast content ka koi jawab nahi.' },
  { name: 'Ayesha Rahman', city: 'Rajshahi', tag: 'Freelancing', text: 'Upwork pe pehla AI design project complete kiya. Module 9 ne game change kar diya.' },
  { name: 'Hasan Mahmud', city: 'Khulna', tag: 'Faceless Page', text: 'Facebook page 0 se 50k followers tak 6 hafton mein. Organic growth ka kamaal.' },
  { name: 'Zarin Tasnim', city: 'Gazipur', tag: 'Skill', text: 'Prompt engineering wala module alone worth tha pure course ka price.' },
]
    ...
    <div className="mx-auto mt-12 max-w-4xl overflow-hidden rounded-2xl bg-[#0F172A] p-8 text-white shadow-xl">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        {[
          ...
          'Bangladesh payment guide (Payoneer, Wise)',
